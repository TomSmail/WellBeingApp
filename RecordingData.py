...
def gatherData(backEndTesting, TrainingModel): # TrainingModel is a bool. 
    ...
    newRow = {"TIME": time.time() ,"INSTAGRAM_l": ia1.readLikes(), "INSTAGRAM_c": ia1.commentReading(), "SPOTIFY_v": sam2.spotifyReadFull(), "VOICE_e": er2.predictValue("audio1.wav"), "USER_i": userInput } 
